...
let s:briofita_support_version = ["3.0.7"]
...
function! g:BriofitaMenu(...) " {{{1
    ...
    let lstmenuops = [
        ...
        \ 'Help,\ About,\ Basics.About  :echomsg "Briofita ' .
        \                                         'v' .
        ...
        \ 'Version.View\ Briofita\ version\ and\ parameters\ \(current\ tabpage\ only\)\ --\ via\ echo\*\ command             :echo g:BriofitaVersion(0)<cr>',
        \ 'Version.-sep044-    <nop>',
        \ 'Version.View\ Briofita\ informational\ variable\ g:briofita_keys\ --\ via\ echomsg\ command   :call g:ShowBriofitaInfo()<cr>',
        \ 'Version.-sep045-    <nop>',
        \ 'Version.-sep046-    <nop>',
        ...
        \ 'Version.\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ View\ Briofita\ version\ and\ parameters\ \(all\ tabpages\)\ --\ via\ echo\*\ command             :echo g:BriofitaVersion(2)<cr>',
        \ 'Version.-sep049-    <nop>',
        \ 'Version.-sep050-    <nop>',
        \ 'Version.-sep051-    <nop>',
        \ '-sep052-       <nop>',
